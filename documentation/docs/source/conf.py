...
project = 'LexNLP'
copyright = '2015-2021, ContraxSuite, LLC'
...
# documentation. A dictionary of options that influence the look and feel of the
# selected theme. These are theme-specific.
...
latex_documents = [
    (master_doc, 'LexNLP.tex', 'LexNLP Documentation',
     'ContraxSuite, LLC', 'manual'),
]
...
man_pages = [
    (master_doc, 'lexnlp', 'LexNLP Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'LexNLP', 'LexNLP Documentation',
     author, 'LexNLP', 'One line description of project.',
     'Miscellaneous'),
]
