...
DOCUMENT_EXAMPLE_1_RESULT_LC = {
    "doc_char_s": 0.2727272727272727,
    "doc_char_p": 0.0,
    "doc_char_a": 0.09090909090909091,
    "doc_char_f": 0.0,
    "doc_char_q": 0.0,
    "doc_char_j": 0.0,
    "doc_char_z": 0.0,
    ...
    "doc_char_m": 0.0,
    "doc_char_y": 0.0,
    "doc_char_t": 0.2727272727272727,
    "doc_char_b": 0.0,
    "doc_char_w": 0.0,
    "doc_char_v": 0.0,
    "doc_char_c": 0.0,
    "doc_char_h": 0.09090909090909091,
    "doc_char_i": 0.18181818181818182,
    "doc_char_e": 0.09090909090909091,
    "doc_char_k": 0.0,
    "doc_char_x": 0.0,
    "doc_char_g": 0.0,
    "doc_char_l": 0.0,
...
DOCUMENT_EXAMPLE_1_RESULT_DI = {
    "doc_char_1": 0.3333333333333333,
    "doc_char_3": 0.3333333333333333,
...
DOCUMENT_EXAMPLE_1_RESULT_PRINT = {
    "doc_char_1": 0.05263157894736842,
    "doc_char_Q": 0.0,
    "doc_char_y": 0.0,
    "doc_char_W": 0.0,
    "doc_char_6": 0.0,
    ...
    "doc_char_K": 0.0,
    "doc_char_`": 0.0,
    "doc_char_h": 0.05263157894736842,
    'doc_char_"': 0.0,
    "doc_char_U": 0.0,
    "doc_char_B": 0.0,
    "doc_char_V": 0.0,
    ...
    "doc_char_$": 0.0,
    "doc_char_\r": 0.0,
    "doc_char_i": 0.10526315789473684,
    "doc_char_\n": 0.0,
    "doc_char_.": 0.0,
    "doc_char_k": 0.0,
    "doc_char_C": 0.0,
    ...
    "doc_char_f": 0.0,
    "doc_char_q": 0.0,
    "doc_char_3": 0.05263157894736842,
    "doc_char_z": 0.0,
    "doc_char_F": 0.0,
    "doc_char_r": 0.0,
    "doc_char_M": 0.0,
    "doc_char_;": 0.0,
    "doc_char_a": 0.05263157894736842,
    "doc_char_D": 0.0,
    "doc_char_t": 0.15789473684210525,
    "doc_char_'": 0.0,
    "doc_char_x": 0.0,
    "doc_char_X": 0.0,
    "doc_char_~": 0.0,
    ...
    "doc_char_d": 0.0,
    "doc_char_^": 0.0,
    "doc_char_s": 0.15789473684210525,
    "doc_char_S": 0.0,
    "doc_char_}": 0.0,
    "doc_char_v": 0.0,
    "doc_char_+": 0.0,
    ...
    "doc_char_c": 0.0,
    "doc_char_A": 0.0,
    "doc_char_e": 0.05263157894736842,
    "doc_char_2": 0.05263157894736842,
    "doc_char_J": 0.0,
    "doc_char_)": 0.0,
    "doc_char_@": 0.0,
    "doc_char_Z": 0.0,
...
class TestParagraphs(TestCase):
    ...
    def test_splitlines_with_spans(self):
        ...
        for text, expected_lines, expected_spans in data:
            ...
            assert actual_lines == expected_lines, f"Actual lines do not match the expected lines for text:\n{text}"
            assert actual_spans == expected_spans, f"Actual spans do not match the expected spans for text:\n{text}"
    ...
    def test_document_distribution_1_custom_nn(self):
        ...
        assert (
            ...
            == DOCUMENT_EXAMPLE_1_RESULT_CUSTOM_NO_NORM
        )
    ...
    def test_document_distribution_empty(self):
        ...
        """
        # Check all dictionaries
        _ = lexnlp_tests.benchmark_extraction_func(build_document_distribution, "", characters=string.printable)
    ...
    @classmethod
    def run_paragraph_test(cls, text: str, expected_paragraphs, window_pre=3, window_post=3):
        """
        ...
        # Get list from text
        actual_paragraphs = get_paragraph_list(text=text, window_pre=window_pre, window_post=window_post)
