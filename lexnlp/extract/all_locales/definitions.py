...
from lexnlp.extract.es.definitions import get_definition_annotations as get_definition_annotations_es
...
ROUTINE_BY_LOCALE = {
    ...
    LANG_ES.code: get_definition_annotations_es,
    LANG_PT.code: get_definition_annotations_pt,
}


def get_definition_annotations(locale: str, text: str, **kwargs) -> Generator[DefinitionAnnotation]:
