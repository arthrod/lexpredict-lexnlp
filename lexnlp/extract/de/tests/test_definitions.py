...
from lexnlp.extract.de.definitions import (
...
class TestParseDeutscheDefinitions(TestCase):
    def test_parse_de_definitions_im_sinne(self):
        ...
        precise_matches = [x for x in ret if x.name.strip(' "') == "Vermögensgegenstände"]
    ...
    def test_parse_de_definitions_quoted(self):
        ...
        self.assertEqual("Moderne Anatomie Mensch", items[0]["tags"]["Extracted Entity Definition Name"].strip(' "'))

    def test_parse_de_definitions_ist_jeder(self):
        text = (
            " ist Diensteanbieter jede natürliche oder juristische Person, die eigene oder fremde "
    ...
    def test_parse_for_clear_def_name(self):
        text = (
            "(3b) Ordnungswidrig handelt, wer als Mitglied des Aufsichtsrats oder als Mitglied eines "
    ...
    def test_file_samples(self):
        ...
        tester.test_and_raise_errors(
            get_definition_annotations, "lexnlp/typed_annotations/de/definition/definitions.txt", DefinitionAnnotation
        )
