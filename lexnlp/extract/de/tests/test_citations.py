...
from lexnlp.extract.de.citations import get_citation_annotations, get_citation_list
...
class TestGetCitations(CustomAssertionMixin):
    ...
    def test_file_samples(self):
        ...
        tester.test_and_raise_errors(
            get_citation_annotations, "lexnlp/typed_annotations/de/citation/citations.txt", CitationAnnotation
        )
