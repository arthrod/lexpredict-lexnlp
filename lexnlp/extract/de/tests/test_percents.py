...
from lexnlp.extract.de.percents import get_percent_annotations, get_percents
...
class TestGetPercents(AssertionMixin):
    def test_percent_prefix(self):
        text = (
            "sie weisen einen vorhandenen Alkoholgehalt von mehr"
    ...
    def test_file_samples(self):
        ...
        tester.test_and_raise_errors(
            get_ordered_percent_annotations, "lexnlp/typed_annotations/de/percent/percents.txt", PercentAnnotation
        )
