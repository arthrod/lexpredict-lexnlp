...
from lexnlp.extract.de.geoentities import get_geoentities_custom_settings, get_geoentity_annotations_custom_settings
...
class TestGetGeoEntities(AssertionMixin):
    def test_diff_sort_priority(self):
        ...
        res = list(
            get_geoentities_custom_settings(
                text,
                entity_df,
        ...
        res = list(
            get_geoentities_custom_settings(
                ...
                priority_direction="desc",
                local_name_column="German Name",
                extra_columns={"ISO-3166-2": "iso_3166_2", "ISO-3166-3": "iso_3166_3"},
            )
        )
    ...
    def test_file_samples(self):
        ...
        tester.test_and_raise_errors(
            get_ordered_geo_annotations, "lexnlp/typed_annotations/de/geoentity/geoentities.txt", GeoAnnotation
        )
