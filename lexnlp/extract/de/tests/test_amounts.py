...
from lexnlp.extract.de.amounts import get_amount_annotations, get_amounts
...
class TestGetAmounts(AssertionMixin):
    ...
    def test_writ_half(self):
        ...
        self.assertOneOK(2422703.5, "zwei Millionen vierhundertzweiundzwanzigtausendsiebenhundertdreieinhalb")
    ...
    def test_file_samples(self):
        ...
        tester.test_and_raise_errors(
            get_amount_annotations, "lexnlp/typed_annotations/de/amount/amounts.txt", AmountAnnotation
        )
