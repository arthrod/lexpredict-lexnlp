...
from lexnlp.extract.de.durations import get_duration_annotations, get_duration_list
...
class TestGetDurations(AssertionMixin):
    ...
    def test_file_samples(self):
        ...
        tester.test_and_raise_errors(
            get_ordered_durations, "lexnlp/typed_annotations/de/duration/durations.txt", DurationAnnotation
        )
