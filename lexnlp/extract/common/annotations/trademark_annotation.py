...
class TrademarkAnnotation(TextAnnotation):
    ...
    def __init__(self, coords: tuple[int, int], locale: str = "en", text: str | None = None, trademark: str = ""):
        """
    ...
    def get_dictionary_values(self) -> dict:
        df = {"tags": {"Extracted Entity Trademark": self.trademark, "Extracted Entity Text": self.text}}
        return df
