...
from lexnlp.extract.pt.copyrights import (
...
class TestParsePtCopyrights(TestCase):
    ...
    def test_parse_simply_phrase(self):
        text = "Website BBC Brasil © 1996 – 2019   "
    ...
    def test_file_samples(self):
        ...
        tester.test_and_raise_errors(
            ...
            "lexnlp/typed_annotations/pt/copyright/copyrights.txt",
            CopyrightAnnotation,
        )
