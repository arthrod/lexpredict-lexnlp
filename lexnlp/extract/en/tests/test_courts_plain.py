...
from lexnlp.extract.en.courts import _get_courts, get_court_annotations, get_court_list, get_courts
...
class TestCourtsPlain(TestCase):
    ...
    def test_file_samples(self):
        ...
        tester.test_and_raise_errors(
            get_court_annotations, "lexnlp/typed_annotations/en/court/courts.txt", CourtAnnotation
        )
