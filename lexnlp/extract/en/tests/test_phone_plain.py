...
from lexnlp.extract.en.pii import get_us_phone_annotations, get_us_phones
...
class TestPhonePlain(TestCase):
    ...
    def test_file_samples(self):
        ...
        tester.test_and_raise_errors(
            get_us_phone_annotations, "lexnlp/typed_annotations/en/phone/phones.txt", PhoneAnnotation
        )
