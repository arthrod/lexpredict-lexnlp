...
from lexnlp.extract.en.durations import get_duration_annotations, get_duration_annotations_list, get_durations
...
class TestDurationsPlain(TestCase):
    ...
    def test_file_samples(self):
        ...
        tester.test_and_raise_errors(
            get_duration_annotations, "lexnlp/typed_annotations/en/duration/durations.txt", DurationAnnotation
        )
