...
from lexnlp.extract.en.cusip import get_cusip_annotations, get_cusip_list
...
class TestGetCUSIP(AssertionMixin):
    ...
    def test_file_samples(self):
        ...
        tester.test_and_raise_errors(
            get_cusip_annotations, "lexnlp/typed_annotations/en/cusip/cusips.txt", CusipAnnotation
        )
