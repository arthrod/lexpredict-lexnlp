...
more  BetLUCK(TM)  Clients for use on multiple  computers  ..."""
        ...
        for ant in ants:
            ...
            self.assertEqual(ant.trademark.replace(" ", ""), ant_text.replace(" ", ""))

    def test_file_samples(self):
        tester = TypedAnnotationsTester()
        tester.test_and_raise_errors(
            get_trademark_annotations, "lexnlp/typed_annotations/en/trademark/trademarks.txt", TrademarkAnnotation
        )
