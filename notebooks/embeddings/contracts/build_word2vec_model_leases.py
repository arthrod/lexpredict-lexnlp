...
if __name__ == "__main__":
    ...
    with tarfile.open("/data/workspace/lexpredict-contraxsuite-core/test_data/lease.tar.gz", "r:gz") as corpus_tar_file:
    ...
    w2v_model_cbow.save("models/w2v_cbow_lease_size200_window10")
    print("cbow trained.")
